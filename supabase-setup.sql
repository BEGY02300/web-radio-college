-- ╔══════════════════════════════════════════════════════════════════╗
-- ║  SCRIPT D'INITIALISATION DE LA BASE SUPABASE — v5 (Web Radio)      ║
-- ╠══════════════════════════════════════════════════════════════════╣
-- ║  Tables :                                                          ║
...
-- ║   2. Collez TOUT ce script et exécutez                             ║
...
-- ═══════════════════════════════════════════════════════════════════
-- 🖼️ STORAGE : BUCKET PUBLIC POUR LES AVATARS
-- ═══════════════════════════════════════════════════════════════════
--
-- Crée le bucket "avatars" public (lecture libre, écriture par
-- l'utilisateur lui-même). Limite : 2 Mo, images uniquement.
--
